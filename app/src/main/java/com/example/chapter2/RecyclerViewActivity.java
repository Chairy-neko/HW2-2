...
public class RecyclerViewActivity extends AppCompatActivity implements MyAdapter.IOnItemClickListener {
    ...
    public int getViewsCount(ViewGroup viewGroup) {
        ...
        for(int i = 0; i < num; ++i) {
            ...
            if(child instanceof ViewGroup) {
                cnt += getViewsCount((ViewGroup) child);
            }
            else {
                cnt++;
            }
...
//        recyclerView.setItemAnimator(animator);
    ...
    protected void onStart() {
        ...
        Toast.makeText(this,"RecyclerViewActivity onStart\nviews number: " + viewsnum,Toast.LENGTH_LONG).show();
    }
    ...
    public void onItemCLick(int position, TestData data) {
        ...
        switch (position) {
            case 0:
                ...
                break;
            case 1:
                Intent intent2 = new Intent(this, UIActivity.class);
                intent2.putExtra(item,position);
                startActivity(intent2);
                break;
            case 2:
                Intent intent3 = new Intent(this, FrameLayoutActivity.class);
                intent3.putExtra(item,position);
                startActivity(intent3);
                break;
            default:
                Intent intent4 = new Intent(this, RelativeLayoutActivity.class);
                intent4.putExtra(item,position);
                startActivity(intent4);
                break;
        }

//        mAdapter.addData(position + 1, new TestData("新增头条", "0w", "ddd"));
    }
